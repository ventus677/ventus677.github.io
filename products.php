    ...
    <div class="page" id="page">
        ...
        <main class="main">
            <section id="homePage" class="active">
                <h1>All About Products</h1>
                <p>View, edit, and add items on your tables or make a new order!</p>
                <div class="cards">
                    <a class="card" id="cardView" data-page="view_productOverview.php">
                        <img src="images/iconTables.png" alt="Tables Icon" class="icon">
                        <span>Manage Products</span>
                    </a>
                    <a class="card" id="cardOrders" data-page="order_products.php">
                        <img src="images/iconOrders.png" alt="Orders Icon" class="icon">
